...
또 해커톤을 진지하게 준비하신다면, SAP 엔지니어링본부의 총괄디자인그룹 PM이신 김영욱 님의 아래 글들을 꼭 읽어보시기를 권해드립니다.
...
해커톤의 목표가 달성되었는지 뭐가 부족했는지를 확인 방법은 [해커톤 마무리](#해커톤-마무리)에서
언급된 설문을 통해 확인이 가능하고, [해커톤 후기들](#해커톤-후기)의 예에서 볼 수 있는
긴 참가 후기들를 잘 살펴보는 것이다. 
...
<details>
<summary>참가자 신청 양식 접기/펼치기</summary>
<p>
...
<details>
<summary>소요 비용 항목 접기/펼치기</summary>
<p>
...
* 인프라 물품
    ...
    (예, [빅썬시스템즈](https://bigsun.kr/Xirrus-제품군), 제품: XK-RDW-200-N, Xirrus 무선인터넷이동형 셋트) 
...
# 해커톤 마무리
 ...
 - 해커톤 평가 설문 하기 :
    모든 참가자들에게 해커톤 평가 설문 응답을 요청하고, 그 결과를 수합하여 성과를 평가하고
    다음 해커톤을 개최할 때 개선하도록 노력한다. 설문은 구글 form을 이용하는 것이 비교적
    무난하다. 설문의 주요 내용은 1. 해커톤이란 행사 자체에 관한 것, 즉 하드웨어적인
    부분 (해커톤 공간, 숙소, 강의 장소 등의 접근성, 쾌적함, 청결 상태, 음식/간식, 
    네트워크 상태, 기타 장비 관련 사항 등),
    소프트웨어적인 부분 (일정상의 모든 진행 방식, 스탭들과의 소통, 멘토의 도움 정도 등),
    2. 해커톤 자체의 목표에 관한 것 (참가 계기, 본인의 역할, 
    그리고 해커톤 참가 전 후 본인의 기술 역량, 협업 역량, 마음가짐 등의 성장 여부 등),
    3. 단도직입적 총평 (질문 예시 '다음에 이 해커톤이 개최된다면 친구에게 추천하시겠습니까?')
    등으로 구성하면 된다. 설문의 개수를 가능하면 줄이고, 구체적인 내용, 건의를 위한 주관식
    항목도 하나 둔다. 
 - 해커톤 사진 :
    주최측에서 공식적으로 찍은 사진, 개인이 찍은 사진들을 공유하기 위한 공유 폴더(구글, 플리커)를
    만들어 공유하고 업로드할 수 있도록 한다
 - 결과 보고서 작성 :
    해커톤 진행 결과를 보고서로 작성하여 행사 주최 기관, 후원자, 참가자 등등에게 공유한다. 
    결과 보고서는 다음 해커톤을 진행할 경우 후원 등등을 미리 결정하는데 
 ...
 - 결과 홍보 :
    ...
    참가한 사람들에 해커톤 경험을 개인 블로그, 소셜미디어에 공유해달라고 부탁한다.
    공유한 사람들에게 약간의 보상을 하는 것도 좋은 방법이다. 2019년 오픈핵의
    행사 후기들 가운데 몇 개의 예가 [해커톤 후기들](#해커톤-후기)에 있다.
 - 결과 홈페이지 구축 :
 ...
 - 해커톤 회고 :
    종료 파티와 별도로, 행사 후속 조치까지 마무리 된 후
    주요 스탭들이 모여, 맛있는 것 먹으면서 해커톤의 잘된 부분, 잘 안되어 개선할 부분들에
    대하여 회고하고, 이 매뉴얼을 개선한다.
...
2019년 오픈핵 해커톤 후기들이다.
어떤 느낌이었는지를 보면 어떻게 준비해야하는지를 알 수 있다.
후기를 성의껏 써주신 분들에게 감사하다.

#### [서강대학교 이건 학생의 후기](https://geonlee.tistory.com/141)
#### [고려대학교 오원정 학생의 후기](https://yolo2429.tistory.com/192)
#### [PUBG 남세현 멘토의 짧은 후기](https://www.facebook.com/100002770952720/posts/1748780365224312?s=100002770952720&sfns=mo)
#### [SAP의 김영욱 멘토 후기 <- 꼭 읽어보실 것](https://www.facebook.com/youngwook.kim.7549/posts/10217770936958615)
