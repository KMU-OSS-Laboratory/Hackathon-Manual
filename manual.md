...
사내 혁신 문화를 만들기 위한 목적.
* 교육 : 해커톤 기간 중 만들어 내는 결과물도 중요하지만, 결과보다는 소프트웨어 개발 방법론, 협업 등 개발 역량을 강화기 위한 목적. 예, OPENHACK(소프트웨어중심대학 오픈소스 해커톤) 
...
행사일 임박할수록, 행사 규모가 클수록, 숙박이 필요할수록, 
